  ...
  return (
    ...
    >
      <Container>
        <Row>
          <Col md={6}>
            <Card style={{ padding: "2rem", borderRadius: "15px", boxShadow: "0 4px 10px rgba(0, 0, 0, 0.1)" }}>
              <Card.Body>
                <h3 className="text-center" style={{ fontSize: "2rem", marginBottom: "1rem" }}>Login</h3>
                <Form onSubmit={handleLogin}>
                  ...
                  {/* Error message */}
                  {error && <p className="text-danger" style={{ fontSize: "1rem", marginBottom: "1rem" }}>{error}</p>}

                  {/* Login button */}
                  <Button variant="primary" type="submit" className="w-100" style={{ padding: "1rem", fontSize: "1.2rem" }}>
                    Login
                  </Button>
                </Form>
              </Card.Body>
